					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input type="email" name="email" id="email" class="form-control" placeholder="Masukan E-Mail..." value="{{ $user->email }}" required>
							</div>
						</div>
						<div class="col-md-4 col-lg-4">
							<div class="form-group">
								<label for="" class="form-control-label">Password : </label>
								<input type="password" name="password" id="password" class="form-control" placeholder="Masukan Password Pengguna..." >
								<span class="text-danger text-sm">
									*Kosongkan bila tidak ingin merubah password
								</span>
							</div>
						</div>
						<div class="col-md-4 col-lg-4">
